...
/****** Objeto: Table [dbo].[movimientos_inventario] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Objeto: Table [dbo].[recuperacion_contrasena] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Objeto: Table [dbo].[RespuestaSeguridad] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** Objeto: Table [dbo].[sesiones_usuario] ******/
SET ANSI_NULLS ON
GO
SET QUOTED_IDENTIFIER ON
GO
...
/****** FOREIGN KEYS - Geografia ******/
ALTER TABLE [dbo].[provincias]  WITH CHECK ADD  CONSTRAINT [FK_provincias_pais] FOREIGN KEY([id_pais])
REFERENCES [dbo].[paises] ([id_pais])
GO
ALTER TABLE [dbo].[provincias] CHECK CONSTRAINT [FK_provincias_pais]
GO
ALTER TABLE [dbo].[cantones]  WITH CHECK ADD  CONSTRAINT [FK_cantones_provincia] FOREIGN KEY([id_provincia])
REFERENCES [dbo].[provincias] ([id_provincia])
GO
ALTER TABLE [dbo].[cantones] CHECK CONSTRAINT [FK_cantones_provincia]
GO
ALTER TABLE [dbo].[distritos]  WITH CHECK ADD  CONSTRAINT [FK_distritos_canton] FOREIGN KEY([id_canton])
REFERENCES [dbo].[cantones] ([id_canton])
GO
ALTER TABLE [dbo].[distritos] CHECK CONSTRAINT [FK_distritos_canton]
GO

/****** FOREIGN KEYS - Resto del esquema ******/
...
GO
ALTER TABLE [dbo].[clientes]  WITH CHECK ADD  CONSTRAINT [FK_clientes_distrito] FOREIGN KEY([id_distrito])
